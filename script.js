...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "resume":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>I am currently pursuing B.E degree in Computer Science Engineering.<br><br>I can comfortably with ci/cd delivery and automation and cloud services :<br>CLOUD PLATFORMS :<br><span class='bold'>Ec2<br>S3<br>Iam<br>Vpc<br>Cloudwatch<br></span><br><br>I've experiance with devops tools :<span class='bold'><br>github<br>docker<br>jenkins<br>terraform</span><br><br>I use <span class='bold'>Arch Linux and window</span> Operating Systems<br><br><br>Favourite IDE:VSCode</span>");
            break;
